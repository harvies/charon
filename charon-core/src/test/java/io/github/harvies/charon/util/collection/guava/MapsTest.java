package io.github.harvies.charon.util.collection.guava;
...
public class MapsTest {
    ...
    public void test1() {
        ...
        Map<Long, User> userMap = Maps.uniqueIndex(list, User::getId);
    ...
    public void arrayListMultimapTest() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            for (int j = 0; j < nextInt; j++) {
                listMultimap.put(i, User.builder().id((long) i).username("username" + i).build());
            }
        }

//package com.jingheng.plugin.domain.com.jingheng.plugin.utils;
//
//import com.jingheng.plugin.common.domain.SupplyResult;
//import com.jingheng.plugin.common.utils.CharsetUtil;
//import com.jingheng.plugin.domain.CefHttpResponse;
...
//
//    private static Logger logger = LoggerFactory.getLogger(CefHttpClient.class);
...
//
//    public SupplyResult<String> execute(CefRequest request, String charset) {
//        SupplyResult<String> supplyResult = new SupplyResult<>();
//        try {
...
//                        supplyResult.setModule(result.getResposeStr());
